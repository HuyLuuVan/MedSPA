...
ALL_IMAGES_PATH="${ALL_IMAGES_PATH:-${REPO_ROOT}/mimic_cxr_all_images.txt}"

OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/results/sft_summary}"
...
echo "[INFO] Starting SFT SUM inference."
...
echo
echo "======================================"
echo "[INFO] SFT SUM inference finished."
