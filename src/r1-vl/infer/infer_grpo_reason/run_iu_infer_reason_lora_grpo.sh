...
ALL_IMAGES_PATH="${ALL_IMAGES_PATH:-${REPO_ROOT}/dataset/iu_all_images.txt}"

FINDINGS_JSON="${FINDINGS_JSON:-${REPO_ROOT}/dataset/iu_gt_findings.json}"

OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/results/iu/grpo_reason}"


PREFIX_IN="${PREFIX_IN:-test_shard}"
...
echo "[INFO] Starting MedSPA PR R-Align inference on IU X-ray."
...
echo
echo "======================================"
echo "[INFO] IU PR R-Align inference finished."
