...
RUN_NAME="${RUN_NAME:-CheXbert_MIMIC_Test_Labeling}"

INPUT_DIR="${INPUT_DIR:-results/mimic/pretrained/shard}"
OUTPUT_DIR="${OUTPUT_DIR:-results/mimic/pretrained/label}"

PREFIX="${PREFIX:-test_reasoning_shard}"
